...
\begin{itemize}
    ...
    \item OBS Studio\cite{obsstudio}: This software was used to capture the DroidCam feed and output it as an "OBS Virtual Camera," which was then selected by the Python script.
\end{itemize}
