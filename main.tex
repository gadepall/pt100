...
\begin{itemize}
    ...
    \item \textbf{Coefficients:} Placeholder: $a=\dots, b=\dots, c=\dots$
\end{itemize}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        2. Inverse LSQ (Wheatstone w/ ADC) & 0.0128 & 0.9999 \\
        3. LSQ (Wheatstone w/ ADC) & [N/A] & [N/A] \\
        4. SGD Regressor (Wheatstone w/ ADC) & 0.2327 & 0.9990 \\
        5. Inverse SGD (Wheatstone w/ ADC) & [N/A] & [N/A] \\
        6. Random Forest (Wheatstone w/ ADC) & 0.0053 & 1.0000 \\
        \bottomrule
    \end{tabular}
\end{table}
