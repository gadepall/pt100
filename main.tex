...
% This project utilizes an auxiliary script for \textbf{automated data collection} by employing Computer Vision and Optical Character Recognition (OCR) to capture paired voltage and temperature readings from physical displays. Note that the training data can be obtained manually and this step can be hence skipped.
